...
if __name__=='__main__':
    ...
    with PlotSettings(14):
        ...
        ax = axs[0,0]
        ax.plot(f*1e-9, mag2db(dut_cal_trl.s[:,0,0]), lw=2, marker='o', markevery=20, markersize=12, label='TRL', linestyle='-')
        ...
        ax.set_yticks(np.arange(-50,10.1,20))
        ax.set_ylim(-50,10)
        
        ax = axs[0,1]
        ax.plot(f*1e-9, mag2db(dut_cal_trl.s[:,1,0]), lw=2, marker='o', markevery=20, markersize=12, label='TRL', linestyle='-')
        ...
        ax.set_yticks(np.arange(-8,4.1,4))
        ax.set_ylim(-8,4)
        #ax.legend(loc='lower left', ncol=1)
        
        ax = axs[1,0]
        ax.plot(f*1e-9, np.angle(dut_cal_trl.s[:,0,0])/np.pi, lw=2, marker='o', markevery=20, markersize=12, label='TRL', linestyle='-')
        ...
        ax = axs[1,1]
        ax.plot(f*1e-9, np.angle(dut_cal_trl.s[:,1,0])/np.pi, lw=2, marker='o', markevery=20, markersize=12, label='TRL', linestyle='-')
        ...
        ax = axs[2,0]
        error_trl = abs(dut_cal_trl.s - dut_cal_trl.s)/abs(dut_cal_trl.s)
        error_ideal = abs(dut_cal_ideal_match.s - dut_cal_trl.s)/abs(dut_cal_trl.s)  
        error_fitted = abs(dut_cal_fitted_match.s - dut_cal_trl.s)/abs(dut_cal_trl.s)
        error_trl_match = abs(dut_cal_trl_match.s - dut_cal_trl.s)/abs(dut_cal_trl.s)
        
        ax.semilogy(f*1e-9, error_ideal[:,0,0], lw=2, marker='X', markevery=20, markersize=12, label='SRM ideal match', linestyle='-.', color='tab:orange')
        ax.semilogy(f*1e-9, error_fitted[:,0,0], lw=2, marker='v', markevery=20, markersize=12, label='SRM fitted match', linestyle='--', color='tab:green')
        ax.semilogy(f*1e-9, error_trl_match[:,0,0], lw=2, marker='^', markevery=20, markersize=12, label='SRM TRL match', linestyle='--', color='tab:red')
        ax.set_xlabel('Frequency (GHz)')
        ax.set_xticks(np.arange(0,50.1,10))
        ax.set_xlim(0,50)
        ...
        ax = axs[2,1]
        ax.semilogy(f*1e-9, error_ideal[:,1,0], lw=2, marker='X', markevery=20, markersize=12, label='SRM ideal match', linestyle='-.', color='tab:orange')
        ax.semilogy(f*1e-9, error_fitted[:,1,0], lw=2, marker='v', markevery=20, markersize=12, label='SRM fitted match', linestyle='--', color='tab:green')
        ax.semilogy(f*1e-9, error_trl_match[:,1,0], lw=2, marker='^', markevery=20, markersize=12, label='SRM TRL match', linestyle='--', color='tab:red')
        ax.set_xlabel('Frequency (GHz)')
        ax.set_xticks(np.arange(0,50.1,10))
        ax.set_xlim(0,50)
